...
export function Profile() {
  ...
  return (
    <SafeAreaView style={styles.profileContainer}>
      ...
      <View style={styles.boxChangePassword}>
        <Svg
      ...
      <View style={styles.boxChangeData}>
        <Svg
          style={styles.changeDataIcon}
          width={20}
          height={20}
          viewBox="0 0 20 20"
          fill="none"
      ...
      <View style={styles.boxProblemsSolution}>
        <Svg
          style={styles.problemsSolutionIcon}
          width={21}
          height={19}
          viewBox="0 0 21 19"
          fill="none"
        ...
        <Text style={styles.problemsSolution}>Solução de problemas</Text>
      </View>
      <View style={styles.boxChangeTheme}>
        <Svg
          style={styles.changeThemeIcon}
          width={20}
          height={20}
          viewBox="0 0 20 20"
          fill="none"
        ...
        <Text style={styles.changeTheme}>Alterar tema</Text>
      </View>
